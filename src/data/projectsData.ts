...
export const projectsData: Project[] = [
  {
    slug: "LFX ISSUE TRACKER",
    title: "LFX Issue Tracker",
    imageTitle: "Landing Page",
    src: "/project-image/image copy.png",
    lightModeSrc: "/project-image/image.png",
    video: "",
    description: "A tool for tracking issues across repositories participating in the LFX program.",
  ...
  },
  {
    ...
    video: "",
    description: "A focused product experience built with a modern full-stack workflow.",
  ...
  },
  {
    ...
    video: "",
    description: "Generate polished presentations with a streamlined, developer-friendly workflow.",
  ...
  },
  {
    ...
    video: "/inquiro.mp4",
    description: "An AI-focused project exploring practical agent and application workflows.",
    tech: ["next", "ts", "radixui", "node", "gemini", "langchain", "langgraph"],
    github: "https://github.com/Kumar-s75/Agentstack",
    live: "",
