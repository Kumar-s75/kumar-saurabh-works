...
export const metadata: Metadata = {
  title: "Resume | Kumar Saurabh",
  description: "Resume of Kumar Saurabh, full-stack developer and open-source contributor.",
};
    ...
    <main className="relative min-h-screen w-full overflow-x-hidden bg-white transition-colors duration-300 dark:bg-black">
      ...
      <section className="relative z-10 ml-0 mr-0 flex min-h-screen flex-col px-4 pb-12 pt-[calc(22vh+112px)] md:ml-[30%] md:mr-[30%]">
        <div className="flex flex-wrap items-center justify-between gap-3 py-4">
          ...
          <div>
            <Link href="/contact" aria-label="Contact Kumar Saurabh">
              <SoftPillButton as="span" variant="primary" className="px-3 py-1.5 !text-[12px]">
                Contact me
              </SoftPillButton>
            </Link>
          </div>
        ...
        <div className="flex min-h-[420px] flex-col justify-between rounded-[6px] border border-black/10 bg-zinc-50 p-6 shadow-sm dark:border-white/10 dark:bg-[#0a0a0a]">
          <div className="max-w-xl space-y-6">
            <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
              Kumar Saurabh is a full-stack developer based in Jalandhar, Punjab, India. He builds practical web products with React, Next.js, Node.js, and modern AI tooling.
            </p>
            <div className="grid gap-4 text-sm text-zinc-600 dark:text-zinc-300 sm:grid-cols-2">
              <div><strong className="text-zinc-900 dark:text-zinc-100">Focus</strong><br />Product engineering, open source, and developer tools</div>
              <div><strong className="text-zinc-900 dark:text-zinc-100">Availability</strong><br />Open to freelance and full-time opportunities</div>
            </div>
          </div>
          <p className="text-xs text-zinc-400 dark:text-zinc-500">A downloadable resume will be added here soon. Contact Kumar directly for the latest version.</p>
        </div>
